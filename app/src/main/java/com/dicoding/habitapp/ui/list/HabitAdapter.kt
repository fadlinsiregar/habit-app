...
class HabitAdapter(
    ...
    override fun onBindViewHolder(holder: HabitViewHolder, position: Int) {
        ...
        when(habit.priorityLevel) {
            "Low" -> holder.ivPriority.setImageResource(R.drawable.ic_priority_low)
            "Medium" -> holder.ivPriority.setImageResource(R.drawable.ic_priority_medium)
            "High" -> holder.ivPriority.setImageResource(R.drawable.ic_priority_high)
        }
    }
